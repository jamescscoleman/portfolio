...
- **UPS / Teamsters (2023):** the National Master Agreement bans inward-facing cameras in UPS vehicles and bars using telematics data alone to discipline drivers. "Wages UP, Cameras OFF!" was an official campaign slogan. Scale facts (verified): **340,000 workers covered**, tentative deal reached **days before the Aug 1 strike deadline** (would have been the largest single-employer strike in US history), ratified **86.3%** with record 58.1% turnout. [Teamsters, NPR, CNN, TDU, contract PDF, FreightWaves] ⚠️ Caveat: the contract still permits driver-facing *sensors* for in-cab audible distraction alerts (a lens-vs-"sensor" wording loophole critics flagged).
